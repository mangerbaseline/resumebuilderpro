...
<head>
    ...
    <style>
        ...
        .section-title { 
            font-size: ${Math.round(10 * s)}px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.2em; color: #2563eb; 
        ...
        .summary-text { font-size: ${Math.round(10 * s)}px; line-height: 1.5; color: #475569; font-weight: 500; white-space: pre-wrap; }
        ...
        .edu-degree { font-size: ${Math.round(10 * s)}px; color: #64748b; font-weight: 700; font-style: italic; margin-top: 1px; }
        .edu-date { font-size: ${Math.round(9 * s)}px; color: #94a3b8; font-weight: 900; margin-top: 1px; }
        ...
        .exp-pos { font-weight: 700; font-size: ${Math.round(13 * s)}px; color: #0f172a; }
        .exp-date { font-size: ${Math.round(9 * s)}px; font-weight: 900; color: #3b82f6; text-transform: uppercase; letter-spacing: 0.1em; }
        .exp-comp { font-weight: 700; color: #475569; font-size: ${Math.round(10 * s)}px; text-transform: uppercase; letter-spacing: 0.1em; margin-top: 1px; margin-bottom: 4px; }
        ...
        .proj-title { font-weight: 800; font-size: ${Math.round(11 * s)}px; color: #0f172a; text-transform: uppercase; }
...
<body>
    <div class="page">
        ...
        <div style="display: flex; flex-direction: column; gap: ${Math.round(18 * s)}px;">
...
<head>
    ...
    <style>
        ...
        .main { flex: 1; padding: 32px 40px; display: flex; flex-direction: column; gap: ${Math.round(20 * s)}px; }
        ...
        .job-title { color: #edf1f7ff; font-weight: 800; text-transform: uppercase; letter-spacing: 0.15em; font-size: ${Math.round(9 * s)}px; margin-top: 8px; }
        .sidebar-title { font-size: ${Math.round(10 * s)}px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.15em; color: #94a3b8; margin-bottom: 10px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 4px; }
        .sidebar-item { font-size: ${Math.round(10 * s)}px; color: #cbd5e1; display: flex; align-items: center; gap: 8px; word-break: break-all; margin-bottom: 8px; }
        .skill-chip { display: flex; align-items: center; gap: 5px; background: rgba(255,255,255,0.08); padding: 4px 10px; border-radius: 4px; font-size: ${Math.round(9 * s)}px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: #fff; margin: 0 6px 6px 0; }
        .section-title { font-size: ${Math.round(11 * s)}px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.2em; color: #1e293b; display: flex; align-items: center; gap: 10px; margin-bottom: 12px; }
        ...
        .item-date { font-size: ${Math.round(10 * s)}px; font-weight: 800; color: #070707ff; text-transform: uppercase; letter-spacing: 0.1em; margin-left: 12px; flex-shrink: 0; background: #eff6ff; padding: 2px 8px; border-radius: 4px; }
        .item-sub { font-weight: 700; color: #64748b; font-size: ${Math.round(10 * s)}px; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; }
                        ...
                        <section>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 10px;">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: start; page-break-inside: avoid;">
                                    <div>
                                        <div style="font-weight: 800; font-size: ${Math.round(12 * s)}px; text-transform: uppercase; color: #0f172a;">${edu.school || ''}</div>
                                        <div style="font-size: ${Math.round(10.5 * s)}px; color: #475569; font-weight: 600; font-style: italic; margin-top: 2px;">${edu.degree || ''}</div>
                                    </div>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                ...
                                <div class="proj-card">
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
                                        <h4 style="font-weight: 800; font-size: ${Math.round(12.5 * s)}px; color: #0f172a;">${proj.title}</h4>
                                    ...
                                    <p class="desc" style="font-size: ${Math.round(10 * s)}px; color: #475569; line-height: 1.5;">${proj.description}</p>
                                </div>`).join('')}
                            </div>
                        </section>` : '';
            default:
...
<head>
    ...
    <style>
        ...
        .h-section { font-size: ${Math.round(18 * s)}px; font-weight: 900; text-transform: uppercase; margin-bottom: 6px; border-bottom: 3px solid #facc15; display: inline-block; padding-bottom: 2px; font-style: italic; letter-spacing: -0.02em; }
        ...
        .exp-item { border-left: 2px solid #f1f5f9; padding-left: 10px; page-break-inside: avoid; }
        .proj-card { border: 2px solid #f8fafc; padding: 8px; border-radius: 6px; page-break-inside: avoid; }
    </style>
</head>
<body>
    <div class="page">
                        ...
                        <section>
                            ...
                            <div style="display: grid; gap: 8px;">
                                ...
                                <div class="proj-card">
                                    ...
                                    <p style="font-size: ${Math.round(10 * s)}px; color: #94a3b8; font-style: italic; line-height: 1.4;">${proj.description || ''}</p>
                                </div>`).join('')}
                            </div>
                        </section>` : '';
            default:
                            ...
                            <div style="display: flex; flex-direction: column; gap: 4px;">
                                ...
                                <div class="education-item">
                                    <div class="item-row">
                                        ...
                                        <span class="bold" style="font-size: ${Math.round(10 * scale)}px; text-transform: uppercase; margin-left: 16px;">${edu.graduationDate || ''}</span>
                                    </div>
                            ...
                            <div style="display: flex; flex-direction: column; gap: 8px;">
                                ...
                                <div class="experience-item">
                                    <div class="item-row bold">
                                        ...
                                        <span style="font-size: ${Math.round(10 * scale)}px; text-transform: uppercase;">${exp.startDate || ''} - ${exp.endDate || ''}</span>
                                    </div>
                                    <div class="item-row italic" style="font-size: ${Math.round(11 * scale)}px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 3px;">
                                ...
                                <div class="project-item">
                                    <div class="item-row bold">
                                        ...
                                        <span class="italic" style="font-size: ${Math.round(10 * scale)}px; font-weight: normal;">
                                    ...
                                    <p class="italic" style="color: #000; margin-top: 0px;">${proj.description || ''}</p>
                                </div>`).join('')}
                            </div>
                        </section>` : '';
            default:
